									...
									<div class="panel panel-body" style="border : 1px solid #e0e0e0; width:95%; height:290px; position : relative;">
										...
										<div class="pad-all text-center">
											...
											<a href="#">
												...
												<label class="badge badge-info"><?php echo $row['jabatan'] == "petugas_lapangan" ? "Petugas Lapangan" : "" ?></label>
												<br>
												<br>
												<!-- Profile Details -->
                                        ...
                                        <div class="modal-body">
                                            <div class="media pad-ver">
                                                ...
                                                <div class="media-right pad-top">
                                                    <a href="<?php echo base_url('account/editAkun?jabatan=petugas_lapangan&id='. $row['id_login']) ?>" class="btn btn-sm btn-default btn-labeled"><i class="btn-label ti-pencil"></i> Sunting</a>
                                                </div>
                                            </div>
