					            ...
					            <div class="fixed-fluid">
					                <div class="fixed-md-200 pull-sm-left fixed-right-border">
					                    ...
					                    <div class="text-center">
					                        <div class="pad-ver">
					                            <img src="<?php echo base_url('assets/img/1.png') ?>" class="img-lg img-circle" alt="Profile Picture">
					                        </div>
					                        <h4 class="text-lg text-overflow mar-no">Aprilia Putri </h4>
					                        <p class="text-sm text-muted">Manager of Jargas Prob</p>
					                    ...
					                    <p><i class="demo-pli-map-marker-2 icon-lg icon-fw"></i> Surabaya, Indonesia</p>
					                    ...
					                    <p class="text-sm text-center">Bekerja sejak 2019 di Jargas Probolinggo. </p>
					                    ...
					                    <div class="row img-gallery">
					                        <div class="col-xs-6">
					                            <img class="img-responsive" src="<?php echo base_url('assets/img/2.jpg') ?>" alt="thumbs">
					                        </div>
					                        <div class="col-xs-6">
					                            <img class="img-responsive" src="<?php echo base_url('assets/img/2.jpg') ?>" alt="thumbs">
					                        </div>
