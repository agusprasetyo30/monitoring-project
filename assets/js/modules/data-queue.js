$(function() {
    ...
    $('.select-by').click(function() {
        ...
        if ( status == "pending" ) {
            ...
            text = "Menampilkan yang sedang berjalan";
        } else if ( status == "finished" ) {

            text = "Menampilkan sudah terlayani";
        } else if ( status == "priority" ) {

            text = "Menampilkan prioritas antrian";
        }
    ...
    // user starred message
    $('#demo-mail-list').on('click', '.starred', function() {
        ...
        $.ajax({
            ...
            type : "GET",
            url  : serverside + 'queue/onUpdateStarredMessage?id=' + id,
            dataType : "json",
    ...
    function showBy( statusAntrian, statusType ) {
        ...
        if ( statusAntrian == "accept" ) text_bagian = "Proses Antrian Berjalan";
        if ( statusAntrian == "finished" ) text_bagian = "Sudah Dilayani";
        if ( statusAntrian == "decline" ) text_bagian = "Ditolak";
        if ( statusAntrian == "priority" ) text_bagian = "Prioritas";
